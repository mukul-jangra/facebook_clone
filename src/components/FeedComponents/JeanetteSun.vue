    ...
    <v-card rounded outlined>
        <div>
            <v-list-item>
                ...
                <v-list-item-content class="mt-2">
                    <v-list-item-title class="subtitle questrial">Japarkash dabas</v-list-item-title>
        ...
        <v-card-text>
         ...
         <v-list-item style="align-items:normal">
                ...
                <v-list-item-content >
                    <div class="questrial font-weight-bold" style="font-size: 14px">Deepak Parkash</div>
