            ...
            <v-card dark color="indigo darken-1" rounded outlined>
                 <v-list-item class="pt-5">
                    ...
                    <v-list-item-content class="mt-2">
                        <v-list-item-title class="questrial subtitle">Karan Kumar</v-list-item-title>
                        <v-list-item-subtitle class="questrial caption">New Delhi, India</v-list-item-subtitle>
                    </v-list-item-content>
                </v-list-item>
                <v-container>
